getDisturbance <- function(currentTime = time(sim), ### ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ STILL NEED TO COPY THIS FUNCTION TO THE caribouPopGrowth!`
  ...
  if (!isRSF){
    ...
    browser()
    # STOPPED HERE! Still need to adapt this function...
    ...
    # Still missing elevation, vrug, shrub, herb and elevation^2, vrug^2 Make a getStaticDisturbance
